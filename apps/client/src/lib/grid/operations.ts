...
import type { Boat, Cell, GridState, Orientation, Position } from "./types";
...
export function setCells(
  grid: GridState,
  updates: { pos: Position; cell: Cell }[],
): GridState {
...
function calculateBoatPosition(boat: {
  startX: number;
  startY: number;
